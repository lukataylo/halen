...
final class OllamaSettingsLoopbackTests: XCTestCase {
    ...
    func testHostnameStartingWith127NotIP() {
        // Edge case: a hostname like "127thingy.local" lexically starts with
        // "127." but isn't a 127/8 IP. With a pure-prefix match this is
        // accepted; documenting the behavior in case a future tightening
        // wants to switch to numeric octet parsing.
        XCTAssertTrue(OllamaSettings.isLoopback(URL(string: "http://127thingy.local:11434")!))
    }
}
